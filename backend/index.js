...
app.post("/upload",upload.single('product'),(req,res)=>{
  res.json({
   success:1,
   image_url:`https://apna-bazar-backend.onrender.com/images/${req.file.filename}`
  })
})
...
// creating api for delating products
...
//creating mmiddelwarre to fetch user
...
//craeting endpoint for adding in cartdata
